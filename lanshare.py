    ...
    def list_directory(self, path):
        ...
        for name in list:
            ...
            if os.path.isdir(fullname):
                ...
                #普通文件下载
                f.write(('<li><a href="%s" download="%s" >%s</a>\n' % (urllib.parse.quote(linkname),urllib.parse.quote(linkname), html.escape(displayname))).encode())  # 添加download，通过三个%s传参
...
if __name__ == '__main__':
    ...
    parser.add_argument('--port', '-p', default=666, type=int,
                        help='Specify alternate port [default: 666]')
